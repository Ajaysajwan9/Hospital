...
<head>
    <meta charset="utf-8">
    <title>SARVANJANA HOSPITAL | BEST HOSPITAL IN RISHIKESH | CONTCT</title>
    ...
    <link href="css/asstes.css" rel="stylesheet">
</head>
                ...
                <div class="col-lg-6">
                    <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h4 class="text-white mb-0">+91 7017960522</h4>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a href="mailto:info@example.com" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h4 class="text-white mb-0">sgmsarvanjnahospital@gmail.com</h4>
                        </div>
                    </a>
                </div>
            </div>
